Locales['es'] = {
  ...
  ['confirm'] = 'Confirmar', --not translated
  -- Vehicles
  ...
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'si',
  ['view'] = 'Ver', --not translated
  ['buy_car'] = 'Comprar', --not translated
  ['stop_view'] = 'Dejar de ver', --not translated
  -- Service
  ...
  -- Action Menu
  ['menu_title'] = 'Policia', --not translated
