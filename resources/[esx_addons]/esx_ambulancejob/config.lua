...
Config.ReviveReward               = 700  -- Recompensa por revivir, poner a 0 en caso de no querer
Config.SaveDeathStatus              = true -- Guardar status de muerte?
Config.LoadIpl                    = true -- Desactivar si usamos fivem-ipl o otras cargas IPL
...
Config.EarlyRespawnTimer          = 60000 * 1  -- tiempo que el respawn esta disponible
Config.BleedoutTimer              = 60000 * 10 -- tiempo que el jugador se desangra

Config.EnablePlayerManagement     = false -- Activar el manager de sociedad (Si usas esx_society).

Config.RemoveWeaponsAfterRPDeath  = true
Config.RemoveCashAfterRPDeath     = true
Config.RemoveItemsAfterRPDeath    = true

-- Pedir dinero para el revive, solo si el jugador tiene el dinero.
